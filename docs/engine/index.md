...
The best way to get started is to begin reading the installation guide [here](/engine/getting-started/installing-mage-engine).

See the [changelog](/engine/changelog) for recent updates.
